...
class ActorConfig(BaseConfig):
    ...
    use_kl_sep: bool = True
    kl_sep_penalty_type: str = "low_var_kl"
    kl_sep_clip: float = 0.2
    kl_sep_coef: float = 0.02

    use_kl_cons: bool = False
    kl_cons_penalty_type: str = "low_var_kl"
    kl_cons_clip: float = 0.2
    kl_cons_coef: float = 0.02
