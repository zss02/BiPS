...
EXPERIMENT_NAME="BiPS_Qwen2.5VL_Stage2"
...
train_files="/mnt/data/BiPS/bips_stage2_train.parquet"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/path/to/BiPS-Stage1 \
    ...
    actor_rollout_ref.actor.kl_sep_coef=$kl_sep_coef \
    actor_rollout_ref.actor.kl_sep_clip=$kl_sep_clip \
